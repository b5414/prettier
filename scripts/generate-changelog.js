...
async function addNewChangelog(prNumber, category, newChangelog) {
	const newChangelogPath = path.resolve(__dirname, `../changelog_unreleased/${category}/${prNumber}.md`);
...
async function createChangelog(title, user, prNumber, category) {
	const changelogTemplatePath = path.resolve(__dirname, '../changelog_unreleased/TEMPLATE.md');
