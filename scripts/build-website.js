...
import {copyFile, DIST_DIR, PROJECT_ROOT, WEBSITE_DIR, writeFile, writeJson} from './utils/index.js';
...
const PRETTIER_DIR = IS_PULL_REQUEST ? DIST_DIR : url.fileURLToPath(new URL('../node_modules/prettier', import.meta.url));
