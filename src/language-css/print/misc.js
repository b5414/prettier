...
function adjustNumbers(value) {
	return value.replaceAll(ADJUST_NUMBERS_REGEX, (match, quote, wordPart, number, unit) => (!wordPart && number ? printCssNumber(number) + maybeToLowerCase(unit || '') : match));
}
...
export {adjustNumbers, adjustStrings, printCssNumber, printUnit, quoteAttributeValue, shouldPrintTrailingComma};
