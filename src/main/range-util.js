...
const isJsonParser = ({parser}) => parser === 'json' || parser === 'json5' || parser === 'jsonc' || parser === 'json-stringify';
...
function dropRootParents(parents) {
	const index = parents.findLastIndex((node) => node.type !== 'Program' && node.type !== 'File');
