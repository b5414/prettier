...
const disjunctionListFormat = (list) => new Intl.ListFormat('en-US', {type: 'disjunction'}).format(list);
...
function getDocErrorMessage(doc) {
	...
	const EXPECTED_TYPE_VALUES = disjunctionListFormat([...VALID_OBJECT_DOC_TYPES].map((type) => `'${type}'`));
