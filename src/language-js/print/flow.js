...
import {printComponent, printComponentParameter, printComponentTypeParameter} from './component.js';
import {printEnumBody, printEnumDeclaration, printEnumMember} from './enum.js';
import {printDeclareHook, printHook, printHookTypeAnnotation} from './hook.js';
import {printInterface} from './interface.js';
import {printBigInt} from './literal.js';
import {printFlowMappedTypeProperty} from './mapped-type.js';
import {printDeclareToken, printOptionalToken, printRestSpread} from './misc.js';
...
function printFlow(path, options, print) {
	...
	switch (node.type) {
		...
		case 'FunctionTypeParam': {
			const name = node.name ? print('name') : path.parent.this === node ? 'this' : '';
			return [
				name,
		...
		case 'TypeCastExpression':
			return ['(', print('expression'), printTypeAnnotationProperty(path, print), ')'];
