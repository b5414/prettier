import {breakParent, group, hardline, join, line} from '../../document/builders.js';
...
function printDecorators(path, options, print) {
	...
	return [path.key === 'declaration' && isExportDeclaration(parent) ? hardline : shouldBreak ? breakParent : '', join(line, path.map(print, 'decorators')), line];
}
...
export {hasDecoratorsBeforeExport, printClassMemberDecorators, printDecorators, printDecoratorsBeforeExport};
