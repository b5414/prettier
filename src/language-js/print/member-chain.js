...
const {getLast, isNextLineEmptyAfterIndex, getNextNonSpaceNonCommentCharacterIndex} = require('../../common/util');
...
const {
	builders: {join, hardline, group, indent, conditionalGroup, breakParent, label},
	utils: {willBreak},
} = require('../../document');
const printCallArguments = require('./call-arguments');
const {printMemberLookup} = require('./member');
const {printOptionalToken, printFunctionTypeParameters, printBindExpressionCallee} = require('./misc');
...
function printMemberChain(path, options, print) {
	...
	function shouldInsertEmptyLineAfter(node) {
		...
		const nextCharIndex = getNextNonSpaceNonCommentCharacterIndex(originalText, node, locEnd);
