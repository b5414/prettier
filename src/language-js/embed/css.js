...
function isStyledJsx({node, parent, grandparent}) {
	return (
		(grandparent &&
			...
			grandparent.openingElement.attributes.some((attribute) => attribute.type === 'JSXAttribute' && attribute.name.name === 'jsx')) ||
		(parent?.type === 'TaggedTemplateExpression' && parent.tag.type === 'Identifier' && parent.tag.name === 'css') ||
