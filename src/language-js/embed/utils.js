import {CommentCheckFlags, hasComment, isArrayOrTupleExpression, isObjectProperty} from '../utils/index.js';
...
function isAngularComponentStyles(path) {
	...
	return (
		...
		) || path.match(isTemplateLiteral, isObjectPropertyNamedStyles, ...angularComponentObjectExpressionPredicates)
	);
}
...
export {hasLanguageComment, isAngularComponentStyles, isAngularComponentTemplate, isAsConstExpression};
