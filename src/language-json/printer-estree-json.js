...
function genericPrint(path, options, print) {
	...
	switch (node.type) {
		...
		case 'ArrayExpression': {
			...
			const printed = path.map(() => (path.node === null ? 'null' : print()), 'elements');
...
const ignoredProperties = new Set(['start', 'end', 'extra', 'loc', 'comments', 'leadingComments', 'trailingComments', 'innerComments', 'errors', 'range', 'tokens']);
