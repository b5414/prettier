...
const getCssStyleTags = (property) =>
	Object.fromEntries(
		htmlUaStyles.flatMap(({type, selectors, styles}) => {
			...
			const tagNames = selectors.filter((selector) => /^[\da-z]+$/iu.test(selector));
...
export {CSS_DISPLAY_DEFAULT, CSS_DISPLAY_TAGS, CSS_WHITE_SPACE_DEFAULT, CSS_WHITE_SPACE_TAGS};
