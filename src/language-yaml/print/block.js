...
const {
	builders: {dedent, dedentToRoot, fill, hardline, join, line, literalline, markAsRoot},
	utils: {getDocParts},
} = require('../../document');
const {getAncestorCount, getBlockValueLineContents, hasIndicatorComment, isLastDescendantNode, isNode} = require('../utils');
