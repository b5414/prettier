...
export default [
	...
	...compat.env({es2024: true, node: true}),
	{
		...
		rules: {
			...
			'import/no-extraneous-dependencies': [
				'error',
				{
					devDependencies: ['jest.config.js', 'tests/**', 'scripts/**', 'website/**/*', 'eslint.config.js'],
				},
			],
	...
	// CommonJS modules
	{
		files: ['**/*.cjs', 'scripts/tools/eslint-plugin-prettier-internal-rules/**/*.js', 'website/**/*.js'],
		languageOptions: {
			sourceType: 'script',
		},
		rules: {
	...
	},
	{
		...
		rules: {
			'n/no-restricted-import': [
				...
				[
					{
						name: [toPath('src/**'), `!${toPath('src/cli/**')}`, `!${toPath('src/index.js')}`],
